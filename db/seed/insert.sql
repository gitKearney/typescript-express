...
INSERT INTO users (email, upassword, person_id)
VALUES
    ('kenny.peppercorn@example.com', '', 2),
    ('fred.fennel@example.com', '', 4),
    ('peter.pimento@example.com', '', 6),
    ('katy.curry@example.com', '', 8);

UPDATE users SET upassword ='$argon2id$v=19$m=65536,t=3,p=4$TFvPvE7SN3/iMoLJSIkiuA$Ek/4dKi59NlA6benQRYSteXV+lf73sGliPFpXPgwHbM'
WHERE person_id > 0;

INSERT INTO users (user_id, email, upassword, person_id) VALUES (0, 'admin', '$argon2id$v=19$m=65536,t=3,p=4$TFvPvE7SN3/iMoLJSIkiuA$Ek/4dKi59NlA6benQRYSteXV+lf73sGliPFpXPgwHbM', 10);
INSERT INTO people (id, first_name, last_name) VALUES (0, 'admin', '');